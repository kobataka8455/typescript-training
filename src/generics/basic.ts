export default function genericsBasicSample() {
  ...
  console.log('Generics basic Sample3:', genericStringReduce(['May ', 'the ', 'force ', 'be ', 'with ', 'you '], ''));
  ...
  console.log('Generics basic Sample4:', genericNumberReduce([-100, -200, -300], 1000));
